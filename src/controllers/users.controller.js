...
const getUsers = async (req, res) => {
    try {
        ...
        res.status(500).json({ message: 'An ERROR has occurred when getting all users.' }, error);
    }
}
...
const getUser = async (req, res) => {
    try {
        ...
        res.status(500).json({ message: 'An ERROR has occurred when getting the user.' }, error);
    }
}
...
const updateUser = async (req, res) => {
    try {
        ...
        res.status(200).json({ message: 'Registry updated successfully.' + updatedUser });
    } catch (error) {
